...
class Program
{
    ...
    static void Main()
    {
        ...
        Thread.Sleep(1000);
        Console.WriteLine("Starting WSBSD OpenBSD 7.7 Kernel...");
        Thread.Sleep(1000);
        Console.WriteLine("Starting WSBSD OpenBSD 7.7...");
        Thread.Sleep(1000);
        Console.WriteLine("All Kernels started Now Starting WSBSD OpenBSD 7.7");
        Thread.Sleep(1000);
...
..------------=#%%%%%%%#------------------------------------------------------------------:::::::::.";
        ...
        Kernel: FREEBSDKERNEL: OpenBSD 7.7 Kernel | BSDKENREL: 4.4BSD-Lite | UNIXKERNEL: Unix Kernel v7.0 | WSBSDKERNEL: WSBSD1.0.0.2
        Uptime: {GetUptime()}
